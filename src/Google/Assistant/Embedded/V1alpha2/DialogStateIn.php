...
class DialogStateIn extends \Google\Protobuf\Internal\Message
{
     ...
     */
    protected $device_location = null;
    /**
     ...
     */
    protected $is_new_conversation = false;
     ...
     *
     * Generated from protobuf field <code>.google.assistant.embedded.v1alpha2.DeviceLocation device_location = 5;</code>
     * @return \Google\Assistant\Embedded\V1alpha2\DeviceLocation|null
     */
    ...
    public function hasDeviceLocation()
    {
        return isset($this->device_location);
    }

    public function clearDeviceLocation()
    {
        unset($this->device_location);
    }
